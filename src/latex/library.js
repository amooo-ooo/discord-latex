...
export function readFileSync( filename )
{
  ...
  if (filesystem[filename]) {
    return Uint8Array.from(Buffer.from(filesystem[filename], 'base64'));
  }
...
export function evaljs(str_number, str_poolp, str_startp, pool_ptrp, pool_size, max_strings,
    ...
    // FIX: Replaced browser-specific 'window' with a safe empty object '{}'
    // to prevent ReferenceError in non-browser environments.
    f(tex, {});
}
